...
export default function Chat() {
  ...
  return (
    <>
      <nav
        className={`${
          isDarkMode ? "bg-zinc-700" : "bg-emerald-900	"
        } text-white p-4 flex justify-between items-center fixed top-0 w-full z-10`}
      >
        ...
        <button
          ...
          className={`text-2xl text-${isDarkMode ? "white" : "black"}`}
        >
      ...
      <div
        className={`min-h-screen flex flex-col justify-between bg-${
      ...
      >
        <div className="flex-grow max-w-90 p-9 overscroll-y-contain	">
          <div className="space-y-4">
            {isEmpty && (
              <div
                className={`flex justify-center p-3 rounded-lg text-3xl text-${
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        ...
                        {m.content.startsWith("```") ? (
                          <pre className="overflow-x-auto bg-black bg-opacity-10 p-3 rounded-md">
